  ...
  return (
    <main className="dashboardShell">
      ...
      <section className="dashboardMain">
        <header className="dashboardHeader"><div><div className="eyebrow">TABLEAU DE BORD</div><h1>{currentOrganization.name}</h1><p>Gère tes formations et démarre une expérience ÉVOOT en direct.</p></div><Link className="primary" href="/dashboard/live/new">+ Nouvelle séance live</Link></header>
        ...
        <section className="panel" id="live"><div className="panelHead"><div><div className="eyebrow">DIRECT</div><h2>Séances live</h2></div></div><div className="emptyState"><strong>Aucune séance active.</strong><p>Choisis une formation et lance une séance. ÉVOOT générera un code participant à 6 chiffres.</p><Link className="primary" href="/dashboard/live/new">Créer une séance live</Link></div></section>
      </section>
    </main>
  );
}
